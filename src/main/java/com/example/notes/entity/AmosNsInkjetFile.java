 ...
 * 喷涂方案-附件信息
 */
@TableName("AMOS_NS_INKJET_FILE")
public class AmosNsInkjetFile extends Model<AmosNsInkjetFile> {
    ...
    public String toString() {
        return "AmosNsInkjetFile{" + "id=" + id + ", businessid=" + businessid + ", tablename=" + tablename + ", fileStatus=" + fileStatus + ", fileName=" + fileName + ", filePath=" + filePath + ", uploaddate=" + uploaddate + ", uploaduser=" + uploaduser + ", isaudit=" + isaudit + ", fileTypeId=" + fileTypeId + ", fileTypeName=" + fileTypeName + ", rejectsRemarks=" + rejectsRemarks + "}";
    }
