 ...
 * 适航证-附件信息
 */
@TableName("AMOS_NS_AIRWORTHY_FILE")
public class AmosNsAirworthyFile extends Model<AmosNsAirworthyFile> {
    ...
    public String toString() {
        return "AmosNsAirworthyFile{" + "id=" + id + ", businessid=" + businessid + ", tablename=" + tablename + ", fileStatus=" + fileStatus + ", fileName=" + fileName + ", filePath=" + filePath + ", uploaddate=" + uploaddate + ", uploaduser=" + uploaduser + ", isaudit=" + isaudit + ", fileTypeId=" + fileTypeId + ", fileTypeName=" + fileTypeName + ", rejectsRemarks=" + rejectsRemarks + "}";
    }
